...
function Input({ className, type, ...props }: ComponentProps<'input'>) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        'h-10 w-full min-w-0 rounded border border-mc-border bg-mc-bg px-4 py-2 text-base text-mc-text shadow-sm outline-none transition-[color,box-shadow,border-color]',
